...
class KLens(Dataset):
    ...
    def __init__(self,raft_path="/content/drive/MyDrive/KLENS/flownet2/DATA/out", root_path="/content/drive/MyDrive/KLENS/flownet2/DATA/datasets/",root_path2="/data2/opticalflow/KLENS/pins/",filenumberlist=["0030","1106","1113","1132","1134","1167","1173"],split="train",ref="",meas=""):
        ...
        for filenum in filenumberlist:
            for raftflowpath in raftflowpaths:
                ...
                if "KLE_"+filenum in raftflowpath:
                    file_list['train'].append([os.path.join(root_path,"KLE_"+filenum+".jpg4.png"),os.path.join(root_path,"KLE_"+filenum+".jpg5.png"),raftflowpath])
